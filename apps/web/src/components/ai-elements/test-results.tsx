      ...
      {children ?? (
        <>
          <div className="flex h-1.5 overflow-hidden rounded-full bg-muted/50">
            <div className="bg-emerald-500 transition-all shadow-[0_0_8px_rgba(16,185,129,0.3)]" style={{ width: `${passedPercent}%` }} />
            <div className="bg-rose-500 transition-all shadow-[0_0_8px_rgba(244,63,94,0.3)]" style={{ width: `${failedPercent}%` }} />
          </div>
